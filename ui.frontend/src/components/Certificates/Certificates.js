...
const Certificates = ({
  ...
  const adding = () => {
    ...
    if (arrayCertificado.length >= 5) setViewFull("");
  };
  ...
  return (
    <DivCertificate>
      <Label
        text={labelcert}
        fontSize={`${fstxtcert}px`}
        color={colorlabelcert}
      />
      ...
      <DivButtons>
        <DivCert>
          <Button
            className={bigButton}
            bgbutton={colorbt}
            colorbutton={colortxtcert}
            brbutton={brbtcert}
            fsbutton={fstxtcert}
            leftImage={leftimagecert}
            rightImage={rightimagecert}
            txtbutton={txtcert}
            onClick={viewOptions}
          />
        ...
        <DivMore>
          <Button
            bgbutton={colorbtmore}
            colorbutton={colortxtmore}
            brbutton={brbtmore}
            fsbutton={fstxtmore}
            leftImage={leftimagemore}
            rightImage={rightimagemore}
            txtbutton={txtmore}
            onClick={adding}
          />
          <Empty className={viewEmpty} color={colorerrorcert}>
            {errortext}
          </Empty>
          <Empty className={viewFull} color={colorerrorcert}>
